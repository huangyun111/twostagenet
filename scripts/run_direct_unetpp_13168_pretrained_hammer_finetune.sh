...
INIT_CHECKPOINT="${INIT_CHECKPOINT:-/home/hy/twostagenet/checkpoints_direct_unetpp_13168/best_val.pth}"
SAVE_DIR="${SAVE_DIR:-${ROOT_DIR}/checkpoints_direct_unetpp_13168_pretrained_hammer}"
GPU_IDS="${GPU_IDS:-5,6}"
...
TRAIN_CMD=(
  "${PYTHON_BIN}" train_direct_unetpp_hammer_finetune.py
  --root_dir "${TRAIN_ROOT}"
...
echo "[train] Direct U-Net++ 13168 pretrained -> HAMMER"
echo "[train] GPU_IDS=${GPU_IDS} batch=${BATCH_SIZE} epochs=${NUM_EPOCHS}"
echo "[train] init=${INIT_CHECKPOINT} save_dir=${SAVE_DIR}"
