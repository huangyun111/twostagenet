...
SAVE_DIR="${SAVE_DIR:-${ROOT_DIR}/checkpoints_stage2_reliability_gated_restormer_vd_13168}"
LOG_FILE="${LOG_FILE:-${ROOT_DIR}/stage2_reliability_gated_restormer_vd_13168_train.log}"
