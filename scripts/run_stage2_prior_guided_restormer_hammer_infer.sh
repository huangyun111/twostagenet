...
CHECKPOINT="${CHECKPOINT:-${ROOT_DIR}/checkpoints_stage2_reliability_gated_restormer_vd_13168/best_val.pth}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/stage2_reliability_gated_restormer_vd_hammer_outputs}"
GPU_ID="${GPU_ID:-0}"
...
ANGLE_RESIDUAL_SCALE="${ANGLE_RESIDUAL_SCALE:-1.5707963267948966}"
